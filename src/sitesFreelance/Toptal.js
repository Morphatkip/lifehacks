    ...
    <div className="container bg-light pt-5">
      <div className="row g-5 ">
        ...
        <div className="col-md-6 ">
          <h1>Toptal</h1>
          <p>
            Toptal is a freelance platform that links organizations with highly
            skilled freelance industry specialists. Toptal's freelancers range
            from web developers and designers to financial consultants and
            product managers <br />. Applying to Toptal as a freelancer
            necessitates completing five phases of the screening procedure,
            ranging from a thorough English exam to a project review. This
            method guarantees that only the best 3% make it to the platform.
            <br />
